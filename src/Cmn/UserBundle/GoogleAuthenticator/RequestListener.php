...
namespace Cmn\UserBundle\GoogleAuthenticator;
...
class RequestListener
{
    ...
    public function onCoreRequest(GetResponseEvent $event)
    {
        ...
        $event->setResponse($this->templating->renderResponse('CmnUserBundle:Admin:Security/two_step_form.html.twig', array(
            'state' => $state,
        )));
    }
}
