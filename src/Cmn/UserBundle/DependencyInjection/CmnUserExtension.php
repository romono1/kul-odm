...
class CmnUserExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('twig.form.resources', array_merge(
            ...
            array('CmnUserBundle:Form:form_admin_fields.html.twig')
        ));
    ...
    public function addDefaults(array $config)
    {
        ...
        $defaultConfig['class']['user'] = sprintf('Cmn\\UserBundle\\%s\\User', $modelType);
        $defaultConfig['class']['group'] = sprintf('Cmn\\UserBundle\\%s\\Group', $modelType);

        $defaultConfig['admin']['user']['class'] = sprintf('Cmn\\UserBundle\\Admin\\%s\\UserAdmin', $modelType);
        $defaultConfig['admin']['group']['class'] = sprintf('Cmn\\UserBundle\\Admin\\%s\\GroupAdmin', $modelType);
